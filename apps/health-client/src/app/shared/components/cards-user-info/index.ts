export * from './address-info-card/address-info-card.component';
export * from './contact-info-card/contact-info-card.component';
export * from './education-medical-worker-info-card/education-medical-worker-info-card.component';
export * from './identification-belarus-citizen-info-card/identification-belarus-citizen-info-card.component';
